...
1. Create a project folder (you can call it `ng-busy` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-ng-busy.git
cd angular-ng-busy
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-ng-busy/archive/master.zip)
...
<table width="100%">
  ...
  <tr>
    ...
    <td>
      A demo <code>NgModule</code> that imports the Library <code>NgBusyModule</code>.
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>
      The library's main <code>NgModule</code>, <code>NgBusyModule</code>.
    </td>
  </tr>
  <tr>
    <td>
...
Use your editor to search the project for all instances of `ng-busy` and change it
